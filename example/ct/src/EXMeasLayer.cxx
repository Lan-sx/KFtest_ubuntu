...
EXMeasLayer::EXMeasLayer(TMaterial &m_in,      // material inside the layer
                         TMaterial &m_out,     // material outside the layer
           ...
           : TVMeasLayer(m_in, m_out, isactive),
             TCylinder(r0, lhalf)
{
}
